...
import type { VocabularyWord, UserStats, LearningSession } from '@/lib/types';
    ...
    async function loadAll() {
      try {
        ...
        const [
          ...
          dbGetAllVocab(),
          dbGet<UserStats>('stats', 'userStats'),
          dbGet<LearningSession[]>('stats', 'sessions'),
          dbGet<{ sessionSize: number }>('stats', 'settings'),
        ...
        setStats(statsData ? { ...DEFAULT_STATS, ...statsData } : DEFAULT_STATS);
        setSessions(sessionsData ?? []);
        setSettings(settingsData ?? { sessionSize: 10 });
