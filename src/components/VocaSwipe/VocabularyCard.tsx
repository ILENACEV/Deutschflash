...
import { RotateCcw, Info, Volume2 } from 'lucide-react';
...
export function VocabularyCard({ word, isTop, onSwipe, className }: VocabularyCardProps) {
  ...
  return (
    ...
    >
      ...
      {isTop && (
        <div className="absolute -bottom-24 left-0 right-0 flex justify-center gap-10">
           <button 
