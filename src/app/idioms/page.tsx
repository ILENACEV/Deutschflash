    ...
    if (gameState === 'playing' && timeLeft > 0) {
      ...
      storage.getStats().then(stats => {
        setHighScore(currentScore => {
          const newHighScore = Math.max(currentScore, stats.highScoreIdioms || 0);
          if (newHighScore > (stats.highScoreIdioms || 0)) {
            storage.saveStats({ ...stats, highScoreIdioms: newHighScore });
          }
          return newHighScore;
        });
      });
