    ...
    if (gameState === 'playing' && timeLeft > 0) {
      ...
      storage.getStats().then(stats => {
        setHighScore(currentScore => {
          const newHighScore = Math.max(currentScore, stats.highScoreVerbs || 0);
          if (newHighScore > (stats.highScoreVerbs || 0)) {
            storage.saveStats({ ...stats, highScoreVerbs: newHighScore });
          }
          return newHighScore;
        });
      });
