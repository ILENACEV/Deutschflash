  ...
  return (
    <div className="min-h-screen bg-background p-6 max-w-md mx-auto font-body pb-20">
      ...
      <section className="space-y-4 mb-8">
        ...
        {/* Activity Heatmap */}
        <Card className="p-6 bg-card rounded-3xl shadow-sm border border-accent/10">
          <h2 className="text-sm font-bold mb-4 flex items-center gap-2 text-muted-foreground uppercase tracking-widest">
            ...
            {heatmapData.map((day, i) => (
              <div 
                ...
                className={cn(
                  ...
                  day.active ? "bg-primary shadow-[0_0_8px_rgba(var(--primary),0.5)]" : "bg-muted/40"
                )}
              />
            ))}
          </div>
          <div className="mt-4 flex items-center gap-2 text-[10px] text-muted-foreground font-medium italic">
            <Info className="w-3 h-3" />
            Приказ на активност во последните 35 дена
          </div>
        </Card>
